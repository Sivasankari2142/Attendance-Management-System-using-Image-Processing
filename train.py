...
message = tk.Label(window, text="Attendance Management System" ,bg="white"  ,fg="black"  ,width=50  ,height=3,font=('comic sans', 30, 'italic bold underline')) 
...
def TakeImages():        
    ...
    if(is_number(Id) and name.isalpha()):
        ...
        with open('StudentDetails\StudentDetails.csv','a+') as csvFile:
            ...
            writer.writerow(row)
        csvFile.close()
        res="Attendance Entered"
        message.configure(text= res)
        os.mkdir("C:/Users/DELL/projects/face/TrainingImage")
        res="Folder Created"
...
shutil.rmtree("C:/Users/DELL/projects/face/TrainingImage", ignore_errors = True)
res="Deleted"
message2.configure(text=res)
